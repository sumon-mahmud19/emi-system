                    ...
                    <tbody>
                        ...
                        @foreach ($customer->purchases as $purchase)
                            ...
                            <tr>
                                ...
                                <td>{{ number_format($downPayment + $totalPaid, 2) }} ৳</td>
                                <td class="{{ $totalDue > 0 ? 'text-danger' : 'text-success' }}">
                                    {{ number_format($totalDue, 2) }} ৳
                                </td>
                                <td>
                                    {{ $purchase->installments->count() }}টি
                                </td>
                                <td>
                                    <a href="{{ route('purchases.show', $purchase->id) }}" class="btn btn-sm btn-primary">বিস্তারিত</a>
                                </td>
                            </tr>
                        @endforeach
                        ...
                        <tr class="fw-bold">
                            <td colspan="7" class="p-3">
                                <div class="bg-light rounded shadow-sm p-3 text-center d-flex flex-md-row justify-content-center align-items-center gap-4">
                                    <div>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover align-middle text-center mb-0">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ auth()->user()->hasRole('admin') ? 4 : 3 }}" class="text-center fst-italic text-muted py-4">
