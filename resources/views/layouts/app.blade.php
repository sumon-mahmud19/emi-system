...
<head>
    ...
    <title>EMI ম্যানেজমেন্ট সিস্টেম</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">EMI সিস্টেম</a>
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown {{ Request::is('reports/*') ? 'active' : '' }}">
                        ...
                        <ul class="dropdown-menu">
                            {{-- <li><a class="dropdown-item {{ Request::is('reports/daily') ? 'active' : '' }}" href="{{ route('daily.reports') }}">দৈনিক রিপোর্ট</a></li> --}}
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        {{-- Uncomment for future login/register --}}
