            ...
            @auth
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown {{ Route::is('customers.*') ? 'active' : '' }}">
                        <a class="nav-link dropdown-toggle" href="#" id="customerDropdown" data-bs-toggle="dropdown">কাস্টমার</a>
                    ...
                    <li class="nav-item dropdown {{ Route::is('purchases.*') ? 'active' : '' }}">
                        <a class="nav-link dropdown-toggle" href="#" id="purchaseDropdown" data-bs-toggle="dropdown">পারচেস</a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="nav-item dropdown {{ Route::is('locations.*') ? 'active' : '' }}">
                        <a class="nav-link dropdown-toggle" href="#" id="locationDropdown" data-bs-toggle="dropdown">লোকেশন</a>
                        <ul class="dropdown-menu">
                            @can('location-list')
                    ...
                    <li class="nav-item dropdown {{ Route::is('users.*') ? 'active' : '' }}">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" data-bs-toggle="dropdown">ইউজার</a>
                        <ul class="dropdown-menu">
                            ...
                            <a class="dropdown-item {{ Route::is('roles.index') ? 'active' : '' }}" href="{{ route('roles.index') }}">রোল ম্যানেজমেন্ট</a>
                            <a class="dropdown-item {{ Route::is('roles.create') ? 'active' : '' }}" href="{{ route('roles.create') }}">নতুন রোল</a>
                        </ul>
                    </li>

                    {{-- পণ্য --}}
                    <li class="nav-item dropdown {{ Route::is('products.*') || Route::is('product-models.*') ? 'active' : '' }}">
                        <a class="nav-link dropdown-toggle" href="#" id="productDropdown" data-bs-toggle="dropdown">পণ্য</a>
                        <ul class="dropdown-menu">
                            @can('product-list')
                    ...
                    <li class="nav-item dropdown {{ Request::is('reports/*') ? 'active' : '' }}">
                        <a class="nav-link dropdown-toggle" href="#" id="reportDropdown" data-bs-toggle="dropdown">রিপোর্ট</a>
                        <ul class="dropdown-menu">
